...
class DatabaseFiller:
    ...
    def fill_fractional_app(self, n):
        for i in range(n):
            ...
            measurement = Measurement.objects.create(type="measurement", time = time, name = "fractional_anal", plant=Plant.objects.get(name="furnace"))
    ...
    def create_settings(self):
        ...
        journals_verbose_names = {
                                    ...
                                    'concentrate_report_journal': 'Журнал рапортов о проделанной работе по складам концентратов',
                                    ...
                                    'leaching_repair_quipment': 'Журнал ремонта',
