    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.CharField(blank=True, choices=[('master', 'Мастер смены'), ('hydro', 'Аппаратчик'), ('admin', 'Админ'), ('boss', 'Начальник цеха'), ('technologist', 'Технолог цеха'), ('senior technologist', 'Главный технолог'), ('senior master', 'Старший мастер'), ('plant master', 'Мастер цеха'), ('department director', 'Начальник отделения'), ('electrolysis duty', 'Дежурный по электролизу')], max_length=128, verbose_name='Должность')),
