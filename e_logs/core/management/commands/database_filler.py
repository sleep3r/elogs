    ...
    def create_formula_sample_data():
        ...
        for group_id in group_ids:
            ...
            for field_name in formula_field_names:
                cell = Cell.get_or_create_cell(group_id=group_id, table_name=table_name,
                    field_name=field_name, index=0)
                cell.value = "FUNC('concentrate_report','small', 'residue_empty_containers11', 0, CURRENT_SHIFT) + FUNC('concentrate_report','small', 'residue_empty_containers21', 0, CURRENT_SHIFT)"
                cell.save()
