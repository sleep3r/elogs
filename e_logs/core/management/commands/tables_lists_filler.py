...
def fill_tables_lists():
    ...
    Setting.objects.bulk_create([
        Setting(
            ...
            name='tables_list',
            value=pickle.dumps(["tables/furnace/furnace_changed_fraction/main.html"])
        ),
        Setting(
            scope=Journal.objects.get(
                plant=Plant.objects.get(name='furnace'),
        ...
        Setting(
            ...
            name='tables_list',
            value=pickle.dumps(["tables/furnace/technological_tasks/main.html"])
        ),
        Setting(
            scope=Journal.objects.get(
                plant=Plant.objects.get(name='furnace'),
        ...
        Setting(
            ...
            name='tables_list',
            value=pickle.dumps(["tables/electrolysis/masters_report/melt_area2.html", "tables/electrolysis/masters_report/zinc.html", "tables/electrolysis/masters_report/melt_area1.html", "tables/electrolysis/masters_report/seria1.html", "tables/electrolysis/masters_report/seria4.html", "tables/electrolysis/masters_report/seria3.html", "tables/electrolysis/masters_report/last.html", "tables/electrolysis/masters_report/params.html"])
        ),
        Setting(
            scope=Journal.objects.get(
                plant=Plant.objects.get(name='electrolysis'),
            ...
            name='tables_list',
            value=pickle.dumps(["tables/electrolysis/electrolysis_technical_report_3_degree/right.html", "tables/electrolysis/electrolysis_technical_report_3_degree/left.html"])
        ),
        Setting(
            scope=Journal.objects.get(
                plant=Plant.objects.get(name='electrolysis'),
            ...
            name='tables_list',
            value=pickle.dumps(["tables/electrolysis/electrolysis_technical_report_4_degree/right.html", "tables/electrolysis/electrolysis_technical_report_4_degree/left.html"])
        ),
        Setting(
            scope=Journal.objects.get(
                plant=Plant.objects.get(name='electrolysis'),
            ...
            name='tables_list',
            value=pickle.dumps(["tables/electrolysis/electrolysis_technical_report_12_degree/right.html", "tables/electrolysis/electrolysis_technical_report_12_degree/left.html"])
        ),
        Setting(
            scope=Journal.objects.get(
                plant=Plant.objects.get(name='electrolysis'),
            ...
            name='tables_list',
            value=pickle.dumps(["tables/electrolysis/electrolysis_repair_report_tables/main.html"])
        ),
        Setting(
            scope=Journal.objects.get(
            ...
            name='tables_list',
            value=pickle.dumps(["tables/leaching/leaching_repair_equipment/repair.html"])
        ),
        Setting(
            scope=Journal.objects.get(
                plant=Plant.objects.get(name='leaching'),
