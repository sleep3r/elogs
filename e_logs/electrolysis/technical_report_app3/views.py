...
@login_required
def index(request):
    context = get_common_context(journal_name="electrolysis_technical_report_3_degree", request=request)
    context.journal_title = 'Технологический журнал электролиза 3-й серии'
