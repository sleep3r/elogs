...
def leaching_jurnal(request):
    ...
    bchc = {
        ...
        'level2': [_("Кобальт Co") + _(', мг/л'), _("Сурьма") + _(', мг/л'), _("Медь") + _(', мг/л'), _("Кадмий"), _("Твердое После 1ст") + _(', г/л'), "pH (BCHC)", _("Железо Fe") + _(', мг/л'), "As" + _(', мг/л'),
                   _("Твёрдое") + _(', г/л'), _("Уд. вес"),
                   _("Кобальт") + _(', мг/л'), _("Сурьма") + _(', мг/л'), _("Кадмий") + _(', мг/л'), _("Твердое") + _(', г/л'), "pH", _("Кадмий") + _(', мг/л'), _("Кобальт") + _(', мг/л'), _("Сурьма") + _(', мг/л'), _("Медь") + _(', мг/л'), _("Железо") + _(', мг/л'),
                   _("Выход по току"), _("Уд. вес"), _("Норма") + _(', мг/л'), _("Факт") + _(', мг/л'), _("Несоответствие") + _(', мг/л'), _("Коррекция"), _("Мастер")],
        'data': data_bchc,
    ...
    baki = {
        ...
        'columns': [_("№ Бака "), _("Кадмий") + _(", мг/л"), _("Медь") + _(", мг/л"), _("Кобальт") + _(", мг/л"),
                    _("Сурьма") + _(", мг/л"), _("Железо") + _(", мг/л"), _("В:T"), _("Уд. вес"), _("Норма"), _("Факт"),
    ...
    probnik = {
        'title': _('Пробник №2'),
        'columns': [_("Время"), "Cd, мг/л", "Cu, мг/л"],
        'rows': [
            {
                'values': ['', '']
            },
